...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String _getAppBarTitle(BuildContext context) {
    ...
    switch (_selectedIndex) {
      case 0:
        return l10n.appTitle; // 'TikTok Downloader'
      case 1:
        return 'Playlist'; // TODO: Use l10n.playlistTab when available
      case 2:
        return 'Authors'; // TODO: Use l10n.authorsTab when available
      case 3:
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            ...
            label: 'Playlist', // TODO: Use l10n.playlistTab when localization is regenerated
          ),
          BottomNavigationBarItem(
            icon: const Icon(Icons.person_outline),
            activeIcon: const Icon(Icons.person),
            label: 'Authors', // TODO: Use l10n.authorsTab when localization is regenerated
          ),
          BottomNavigationBarItem(
